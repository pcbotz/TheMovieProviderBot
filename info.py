...
auth_channel = environ.get('AUTH_CHANNEL', '-1002133014283') #Channel / Group Id for force sub ( make sure bot is admin )
...
P_TTI_SHOW_OFF = is_enabled((environ.get('P_TTI_SHOW_OFF', "True")), True) # just edited 
...
if HAS_SSL:
    URL = "https://social-ellen-hjmjuhvyguk-25a49df7.koyeb.app/".format(FQDN)
else:
    URL = "https://social-ellen-hjmjuhvyguk-25a49df7.koyeb.app/".format(FQDN)

# add premium logs channel id
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002113853127'))
